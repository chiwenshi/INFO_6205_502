...
public class Knapsack {
    ...
    private boolean[][] population = null; //the last generation of the population  
    private float[] fitness = null; //fitness of the population  
  
    private float bestFitness; //the price of the item who has the best fitness  
